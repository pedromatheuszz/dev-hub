...
const useDevHub = create((set, get) => ({
  ...
  async init(api2) {
    ...
    const [tema, fonte] = await Promise.all([
      api2.getSetting("theme"),
      api2.getSetting("fontScale")
    ]);
    set({
      themePref: tema ?? "system",
  ...
  async refresh() {
    const { api: api2, route } = get();
    if (!api2) return;
    set({ loading: true, error: null });
    try {
      const items = route.name === "saved" ? await api2.saved(LIMITE_FEED) : await api2.feed(categoriaDaRota(route), LIMITE_FEED);
  ...
  async setSearchQuery(q) {
    ...
    set({ searching: true });
    try {
      const r = await api2.search(q, 30);
  ...
  async toggleSaved(articleId) {
    const api2 = get().api;
    if (!api2) return;
    const saved = await api2.toggleSaved(articleId);
    const items = get().items.map((i) => i.article.id === articleId ? { ...i, saved } : i).filter((i) => get().route.name !== "saved" || i.saved);
    set({
      items,
  ...
  async runIngest() {
    const api2 = get().api;
    if (!api2 || get().ingesting) return;
    set({ ingesting: true, error: null });
    try {
      const lastIngest = await api2.ingest();
...
function tempoRelativo(ts, agora = Date.now()) {
  const min = Math.floor((agora - ts) / 6e4);
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card-foot", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "chip chip-cat", children: rotuloCategoria(story.category) }),
          story.isBreaking && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "chip chip-breaking", children: "Última hora" }),
          article.contentType !== "news" && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "chip chip-type", children: rotuloTipo(article.contentType) }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "card-title", children: story.canonicalTitle }),
        article.excerpt && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "card-excerpt", children: article.excerpt }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card-meta", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: hostDe(article.url) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "dot-sep", children: "·" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: tempoRelativo(article.publishedAt) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "dot-sep", children: "·" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
            article.readingMinutes,
            " min"
          ] }),
          story.articleCount > 1 && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "dot-sep", children: "·" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
              story.articleCount,
              " fontes"
        ...
        tags.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "card-foot", style: { flexWrap: "wrap" }, children: tags.slice(0, 4).map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "chip chip-tag", children: t }, t)) }),
        mostrarScore && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: "score",
            title: `Por que estou vendo isto — o score é o produto destes cinco fatores:
...
=  total .............. ${b.total.toFixed(4)}`,
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "score-total", children: b.total.toFixed(3) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "score-x", children: "·" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
                "F",
                b.freshness.toFixed(2).slice(1)
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
                "C",
                b.trust.toFixed(2).slice(1)
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
                "I",
                b.importance.toFixed(2).slice(1)
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
                "A",
                b.affinity.toFixed(1)
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
                "D",
                b.dedupPenalty.toFixed(1)
              ] })
            ]
          }
        )
...
function Vazio({ rota, aoIngerir, ingerindo }) {
  if (rota === "saved") {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "empty", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "empty-icon", "aria-hidden": "true", children: "★" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "empty-title", children: "Nenhum artigo salvo ainda" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "empty-hint", children: [
        "Clique na estrela de qualquer card, ou pressione ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "kbd", children: "S" }),
        " com o card em foco, para guardar um artigo aqui."
      ] })
    ] });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "empty", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "empty-icon", "aria-hidden": "true", children: "◈" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "empty-title", children: "Nada no feed ainda" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "empty-hint", children: "Busque as notícias das 37 fontes configuradas. A primeira vez leva cerca de um minuto; depois só o que mudou é baixado." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "btn btn-primary", onClick: aoIngerir, disabled: ingerindo, children: ingerindo ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "spin", children: "◌" }),
      " Buscando…"
    ] }) : "Buscar notícias agora" })
  ] });
}
function Esqueletos() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid", children: Array.from({ length: 9 }, (_, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "skeleton" }, i)) });
}
function Secao({ titulo, itens, offset }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "section-head", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "section-count", children: itens.length })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid", children: itens.map((item, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      StoryCard,
      {
        item,
...
function FeedView() {
  ...
  if (loading && items.length === 0) return /* @__PURE__ */ jsxRuntimeExports.jsx(Esqueletos, {});
  if (error) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "banner banner-error", role: "alert", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { "aria-hidden": "true", children: "⚠" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: error })
    ] });
  }
  if (items.length === 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Vazio, { rota: rota.name, aoIngerir: () => void runIngest(), ingerindo: ingesting });
  }
  if (rota.name !== "home") {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Secao, { titulo: tituloDaRota(rota.name), itens: items, offset: 0 });
  }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: secoes.map(([titulo, lista]) => {
    const offset = n;
    n += lista.length;
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Secao, { titulo, itens: lista, offset }, titulo);
  }) });
}
...
function Reader({ id }) {
  const [dados, setDados] = reactExports.useState(null);
  ...
  if (carregando) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "reader", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "skeleton", style: { height: 320 } }) });
  }
  if (!dados) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "empty", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "empty-icon", "aria-hidden": "true", children: "?" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "empty-title", children: "Artigo não encontrado" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "btn", onClick: () => void goBack(), children: "Voltar" })
    ] });
  }
  const { article, tags } = dados;
  const temCorpo = (article.contentHtml ?? "").length > 200;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: "reader", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "btn btn-ghost reader-back", onClick: () => void goBack(), children: "← Voltar" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { children: article.title }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "reader-meta", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: hostDe(article.url) }),
      article.author && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "dot-sep", children: "·" }),
    ...
    tags.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "reader-tags", children: tags.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "chip chip-tag", children: t }, t)) }),
    article.excerpt && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "reader-summary", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "reader-summary-head", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "chip chip-ai", children: "Resumo do feed" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { margin: 0 }, children: article.excerpt })
    ] }),
    temCorpo ? /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        className: "reader-body",
        dangerouslySetInnerHTML: { __html: article.contentHtml }
      }
    ) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "banner banner-info", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { "aria-hidden": "true", children: "ℹ" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Esta fonte publica apenas um resumo no feed. Leia o artigo completo no site original." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "reader-actions", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          className: "btn btn-primary",
          onClick: () => void api.openExternal(article.url),
          children: "Abrir no site original ↗"
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "btn", onClick: () => void toggleSaved(article.id), children: salvo ? "★ Salvo" : "☆ Salvar" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          className: "btn",
...
function SearchOverlay() {
  ...
  const navigate = useDevHub((s) => s.navigate);
  const [foco, setFoco] = reactExports.useState(0);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      "aria-modal": "true",
      "aria-label": "Busca",
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "search-panel", onClick: (e) => e.stopPropagation(), children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            ref: inputRef,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "search-results", children: [
          buscando && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "empty", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "spin", children: "◌" }) }),
          !buscando && query.trim().length >= 2 && resultados.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "empty", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "empty-hint", children: [
            "Nenhum resultado para “",
            query,
            "”."
          ] }) }),
          !buscando && query.trim().length < 2 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "empty", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "empty-hint", children: "Digite ao menos dois caracteres. A busca roda no índice local, sem internet." }) }),
          resultados.map((r, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "search-hit-title", children: r.article.title }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "search-hit-meta", children: [
                  hostDe(r.article.url),
                  " · ",
                  tempoRelativo(r.article.publishedAt),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "search-foot", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
          ...
          resultados.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: { marginLeft: "auto" }, children: [
            resultados.length,
            " resultados"
          ] })
        ] })
...
function Settings() {
  ...
  const [fontes, setFontes] = reactExports.useState([]);
  reactExports.useEffect(() => {
    void api.sources().then(setFontes);
  }, [ingesting]);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "settings", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-head", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Aparência" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "setting-row", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "setting-label", children: "Tema" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "setting-hint", children: "“Sistema” acompanha a preferência do Windows automaticamente." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "segmented", role: "group", "aria-label": "Tema", children: TEMAS.map(([v, rotulo]) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "setting-row", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "setting-label", children: "Tamanho do texto" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "setting-hint", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: "var(--sp-sm)", alignItems: "center" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "btn", onClick: () => void setFontScale(fontScale - 0.1), children: "−" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "btn", onClick: () => void setFontScale(1), children: "100%" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "btn", onClick: () => void setFontScale(fontScale + 0.1), children: "+" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-head", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Conteúdo" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "setting-row", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "setting-label", children: "Buscar notícias" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "setting-hint", children: lastIngest ? `Última vez: ${lastIngest.itensNovos} artigos novos de ${lastIngest.fontesLidas} fontes, ${lastIngest.itensFiltrados} filtrados por irrelevância.` : "Baixa as novidades de todas as fontes ativas. Só o que mudou é transferido." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "btn btn-primary", onClick: () => void runIngest(), disabled: ingesting, children: ingesting ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "spin", children: "◌" }),
        " Buscando…"
      ] }) : "Buscar agora" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "setting-row", style: { borderBottom: "none" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "setting-label", children: "Resumos por IA" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "setting-hint", children: "Hoje o Dev Hub usa classificação e resumo heurísticos, que rodam localmente e sem custo. A integração com o Gemini chega na Fase 5." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "chip chip-type", children: "Heurístico" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "section-head", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Fontes" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "section-count", children: [
        fontes.length,
        " ativas"
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "source-table", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { children: "Fonte" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { children: "Tipo" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { children: "Confiança" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { children: "Última leitura" })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: fontes.map((f) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: f.name }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: ROTULO_TIPO_FONTE[f.kind] ?? f.kind }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "mono", children: f.trustWeight.toFixed(2) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "mono", children: f.lastFetchedAt ? tempoRelativo(f.lastFetchedAt) : "nunca" })
      ] }, f.id)) })
    ] })
  ] });
}
  ...
  function item(e) {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        ...
        title: collapsed ? `${e.texto} (${e.atalho})` : void 0,
        "aria-current": ativo ? "page" : void 0,
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "nav-icon", "aria-hidden": "true", children: e.icone }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "nav-text", children: e.texto }),
          e.cor && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "nav-dot", style: { background: e.cor } })
        ]
      },
      `${e.rota.name}-${e.texto}`
    );
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: `sidebar${collapsed ? " collapsed" : ""}`, "aria-label": "Navegação principal", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "brand", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "brand-mark", "aria-hidden": "true", children: ">_" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "brand-text", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "brand-name", children: "Dev Hub" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "brand-tag", children: "Technology · Code" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "nav-group", children: PRINCIPAL.map(item) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "nav-label", children: "Categorias" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "nav-group", children: CATEGORIAS.map(item) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "nav-label", children: "Meu conteúdo" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "nav-group", children: PESSOAL.map(item) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sidebar-foot nav-group", children: item({ rota: { name: "settings" }, icone: "⚙", texto: "Configurações", atalho: "9" }) })
  ] });
}
const light = {
  bg: "#FFFFFF",
...
function aplicarTema(pref, fontScale) {
  const escuroDoSistema = window.matchMedia("(prefers-color-scheme: dark)").matches;
  const nome = pref === "system" ? escuroDoSistema ? "dark" : "light" : pref;
...
function App() {
  ...
  const setFontScale = useDevHub((s) => s.setFontScale);
  const [recolhida, setRecolhida] = reactExports.useState(false);
  const [pronto, setPronto] = reactExports.useState(false);
  reactExports.useEffect(() => {
    void init(api).then(() => setPronto(true));
  }, [init]);
  reactExports.useEffect(() => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "app", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Sidebar, { collapsed: recolhida }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "main", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "topbar", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { children: tituloDe(rota) }),
        loading && items.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "spin", "aria-hidden": "true", children: "◌" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "topbar-spacer" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "search-trigger", onClick: openSearch, "aria-label": "Abrir busca", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { "aria-hidden": "true", children: "⌕" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Buscar…" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "kbd", children: "Ctrl K" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            children: ingesting ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "spin", children: "◌" }),
              " Buscando…"
            ] }) : "↻ Atualizar"
          }
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "content", children: !pronto ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "empty", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "spin", "aria-hidden": "true", children: "◌" }) }) : rota.name === "settings" ? /* @__PURE__ */ jsxRuntimeExports.jsx(Settings, {}) : rota.name === "article" ? /* @__PURE__ */ jsxRuntimeExports.jsx(Reader, { id: rota.id }) : rota.name === "following" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "empty", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "empty-icon", "aria-hidden": "true", children: "◎" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "empty-title", children: "Seguir tópicos chega na Fase 4" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "empty-hint", children: "Aqui você vai escolher linguagens, frameworks, empresas e hardware para priorizar no seu feed. O fator de afinidade do ranking já está no lugar, esperando esses dados." })
      ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx(FeedView, {}) })
    ] }),
...
clientExports.createRoot(raiz).render(
